...
def cli(port, data_dir, identifier, prod, workers, setting_file, logging_conf, gunicorn_config, log_level):
    setting = AppSetting(port=port, data_dir=data_dir, identifier=identifier, prod=prod).reload(setting_file)
    options = {
