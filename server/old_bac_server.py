...
# from bacpypes.local.object import AnalogOutputCmdObject, BinaryOutputCmdObject, AnalogValueCmdObject, \
...
#
#
# class BinaryOutputFeedbackObject(BinaryValueCmdObject):
...
#         [priority_array, present_value] = default_values(object_type, i, default_pv, db, Points)
#         print((object_type, i), vars(priority_array), present_value)
