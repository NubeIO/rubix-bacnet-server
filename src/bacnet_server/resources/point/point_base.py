...
class BACnetPointBase(Resource):
    ...
    parser.add_argument('object_identifier', type=str, required=True)
    ...
    parser.add_argument('relinquish_default', type=float, required=True)
    parser.add_argument('priority_value', type=str, required=True)
    parser.add_argument('priority_num', type=int, required=True)
    parser.add_argument('units', type=str, required=False)
    parser.add_argument('description', type=str, required=True)
    parser.add_argument('enable', type=bool, required=True)
    parser.add_argument('fault', type=bool, required=True)
